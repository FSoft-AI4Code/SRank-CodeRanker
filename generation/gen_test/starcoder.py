...
#     prompt = f"<filename>solutions/solution_1.py\n{input}\n    pass\n# check the correctness of {entry_point}\nassert {entry_point}("
#     return prompt
...
def main():
    ...
    entry_points = [problems[task_id]['entry_point'] for task_id in task_ids]
    ...
    for i in tqdm(range(num_samples), ncols=0, total=num_samples):
        ...
        prompt_batch = [generate_prompt(prompt, entry_point, args.model)]
        ...
        for _ in tqdm(range(loops), total=loops, leave=False, ncols=0):
            ...
            if gen_seqs is not None:
                ...
                for seq_idx, gen_seq in enumerate(gen_seqs):
                    ...
                    # completion_seq = gen_seq.split(prompt)[1]
